...
// #include <iostream>
// std::vector<std::string> get_pins(std::string observed) {
//   std::map<int, std::vector<int>> combination;
//   combination[1] = {2, 4};
//   combination[2] = {1, 2, 5};
//   combination[3] = {2, 5};
//   combination[4] = {1, 7, 5};
//   combination[5] = {2, 4, 6, 8};
//   combination[6] = {3, 5, 9};
//   combination[7] = {4, 8};
//   combination[8] = {7, 5, 9, 0};
//   combination[9] = {8, 6};
//   combination[0] = {8};
//   std::vector<std::string> ans;
//   int i = 0;
//   int len = observed.length()-1;
//   while (observed[i] != '\0') {
//     auto it = combination.find(observed[i] - '0');
//     for (auto j : it->second) {
//       std::string temp = observed;
//       temp[i] = char(j+48);
//       ans.push_back(temp);
//     }
//     i++;
...
// int main() {
//   std::vector<std::string> ans = get_pins("11");
//   for (auto i : ans) {
//    std::cout<<i<<"\n";
//   }
// }
